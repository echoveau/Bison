...
#line 126 "parser.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_SOMME (const location_type& l);
    ...
    static inline
    symbol_type
    make_PO (const location_type& l);

    static inline
    symbol_type
    make_PF (const location_type& l);
    ...
    static inline
    symbol_type
    make_EGEG (const location_type& l);
    ...
    static inline
    symbol_type
    make_XOU (const location_type& l);
...
#line 754 "parser.hh" // lalr1.cc:377
